...
def production_retrieve(
    ...
    if "transformer" in query_lower:
        ...
        if any(term in query_lower for term in [
            ...
            focused_terms = [
                "training", "sequence-to-sequence", "optimization",
                "learning rate", "label smoothing", "Adam", "loss"
            ]
        elif any(term in query_lower for term in [
            ...
            focused_terms = [
                "self-attention computational complexity", "sequence length",
                "computational cost", "attention complexity", "n squared", "n < d"
            ]
        elif any(term in query_lower for term in [
